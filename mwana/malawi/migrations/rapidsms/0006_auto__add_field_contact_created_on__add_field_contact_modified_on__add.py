...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'rapidsms_contact', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2013, 10, 10), blank=True), keep_default=False)

        # Adding field 'Contact.modified_on'
        db.add_column(u'rapidsms_contact', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2013, 10, 10), blank=True), keep_default=False)

        # Adding field 'Connection.created_on'
        db.add_column(u'rapidsms_connection', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2013, 10, 10), blank=True), keep_default=False)

        # Adding field 'Connection.modified_on'
        db.add_column(u'rapidsms_connection', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2013, 10, 10), blank=True), keep_default=False)
