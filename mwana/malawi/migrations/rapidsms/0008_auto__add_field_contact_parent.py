...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'rapidsms_contact', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Contact'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.parent'
        db.delete_column(u'rapidsms_contact', 'parent_id')
