...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('rapidsms_contact', 'alias', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'Contact.alias'
        db.alter_column('rapidsms_contact', 'alias', self.gf('django.db.models.fields.CharField')(default='', max_length=20, unique=True))
