...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Connection', fields ['identity', 'backend']
        db.create_unique('rapidsms_connection', ['identity', 'backend_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Connection', fields ['identity', 'backend']
        db.delete_unique('rapidsms_connection', ['identity', 'backend_id'])
