...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contact.date_of_birth'
        db.add_column(u'rapidsms_contact', 'date_of_birth', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.date_of_birth'
        db.delete_column(u'rapidsms_contact', 'date_of_birth')
