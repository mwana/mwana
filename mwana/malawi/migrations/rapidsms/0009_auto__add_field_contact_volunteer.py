...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contact.volunteer'
        db.add_column(u'rapidsms_contact', 'volunteer', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.volunteer'
        db.delete_column(u'rapidsms_contact', 'volunteer')
