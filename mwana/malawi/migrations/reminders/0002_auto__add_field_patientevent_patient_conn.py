...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PatientEvent.patient_conn'
        db.add_column('reminders_patientevent', 'patient_conn', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='patient_connections', null=True, to=orm['rapidsms.Connection']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PatientEvent.patient_conn'
        db.delete_column('reminders_patientevent', 'patient_conn_id')
    ...
    models = {
        ...
        'reminders.patientevent': {
            ...
            'patient_conn': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'patient_connections'", 'null': 'True', 'to': "orm['rapidsms.Connection']"})
        },
