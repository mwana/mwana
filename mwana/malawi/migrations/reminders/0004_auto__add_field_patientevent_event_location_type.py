...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PatientEvent.event_location_type'
        db.add_column('reminders_patientevent', 'event_location_type', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PatientEvent.event_location_type'
        db.delete_column('reminders_patientevent', 'event_location_type')
