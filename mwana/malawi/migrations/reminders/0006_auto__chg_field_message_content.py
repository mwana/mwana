...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('reminders_message', 'content', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'Message.content'
        db.alter_column('reminders_message', 'content', self.gf('django.db.models.fields.CharField')(max_length=255))
