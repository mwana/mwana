...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('reminders_message', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('appointment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='messages', to=orm['reminders.Appointment'])),
            ('content', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('recipient_type', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
        ))
        db.send_create_signal('reminders', ['Message'])


    def backwards(self, orm):
        
        # Deleting model 'Message'
        db.delete_table('reminders_message')
