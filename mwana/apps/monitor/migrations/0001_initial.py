...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MonitorMessageRecipient'
        db.create_table(u'monitor_monitormessagerecipient', (
        ...
        db.send_create_signal(u'monitor', ['MonitorMessageRecipient'])

        # Adding model 'MonitorSample'
        db.create_table(u'monitor_monitorsample', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sample_id', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('payload', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labresults.Payload'], null=True, blank=True)),
            ('sync', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ...
            ('hmis', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
        ))
        db.send_create_signal(u'monitor', ['MonitorSample'])


    def backwards(self, orm):
        # Deleting model 'MonitorMessageRecipient'
        db.delete_table(u'monitor_monitormessagerecipient')

        # Deleting model 'MonitorSample'
        db.delete_table(u'monitor_monitorsample')
