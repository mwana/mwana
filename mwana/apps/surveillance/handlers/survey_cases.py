...
class SurveyCaseHandler(KeywordHandler):
    ...
    HELP_TEXT = "To report cases, send CASE <DATE> <CASE-ONE> <VALUE-ONE>, <CASE-TWO> <VALUE-TWO>, e.g. CASE 17 10 2013, Malaria 12, Diarrhoea 12."
    ...
    def handle(self, text):
        ...
        rpr_date = self._parse_date(tokens[0])
        ...
        for case_rpt in cases:
            ...
            if rpr_date: report.date = rpr_date
            now = datetime.now()
