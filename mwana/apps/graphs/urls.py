...
urlpatterns = patterns('',
    ...
    url(r"^messages_by_partner/$", views.messages_by_partner, name="messages_by_partner"),
    ...
    url(r"^monthly_results_retrieval_trends/$", views.monthly_results_retrieval_trends, name="monthly_results_retrieval_trends"),
    url(r"^monthly_results_retrieval_trends_by_province/$", views.monthly_results_retrieval_trends_by_province, name="monthly_results_retrieval_trends_by_province"),
