...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EIDConfirmation.contact'
        db.alter_column(u'labresults_eidconfirmation', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Contact'], null=True))

        # Changing field 'EIDConfirmation.result'
        db.alter_column(u'labresults_eidconfirmation', 'result_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labresults.Result'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'EIDConfirmation.contact'
        raise RuntimeError("Cannot reverse this migration. 'EIDConfirmation.contact' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'EIDConfirmation.result'
        raise RuntimeError("Cannot reverse this migration. 'EIDConfirmation.result' and its values cannot be restored.")
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 4, 0, 33, 54, 967919)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 4, 0, 33, 54, 967208)'}),
