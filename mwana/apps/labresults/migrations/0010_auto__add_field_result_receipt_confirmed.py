...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Result.receipt_confirmed'
        db.add_column(u'labresults_result', 'receipt_confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Result.receipt_confirmed'
        db.delete_column(u'labresults_result', 'receipt_confirmed')
