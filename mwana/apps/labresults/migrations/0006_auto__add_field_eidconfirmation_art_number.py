...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EIDConfirmation.art_number'
        db.add_column(u'labresults_eidconfirmation', 'art_number', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EIDConfirmation.art_number'
        db.delete_column(u'labresults_eidconfirmation', 'art_number')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 5, 16, 53, 30, 224559)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 5, 16, 53, 30, 223866)'}),
