...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EIDConfirmation'
        db.create_table(u'labresults_eidconfirmation', (
            ...
            ('sample', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('age_on_report', self.gf('django.db.models.fields.DateTimeField')()),
            ('action_taken', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True)),
        ))
        db.send_create_signal(u'labresults', ['EIDConfirmation'])


    def backwards(self, orm):
        
        # Deleting model 'EIDConfirmation'
        db.delete_table(u'labresults_eidconfirmation')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 3, 23, 2, 33, 292878)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 3, 23, 2, 33, 292078)'}),
        ...
        u'labresults.eidconfirmation': {
            ...
            'age_on_report': ('django.db.models.fields.DateTimeField', [], {}),
