...
PRINTER_RESULTS_READY = "Hello %(name)s. We have %(count)s DBS test results ready for you. Please switch on the printer and press the 'PLS CALL' button to retrieve them."
