...
#    "Hi %(cba)s.%(patient)s is due for %(type)s clinic visit.Please remind them to visit %(clinic)s within 3 days then reply with TOLD %(patient)s"
    ...
    def _register(self):
        ...
        Location.objects.create(name="Kafue District Hospital", slug="kdh",
                                type=clinic)
        script = """
            +260977600123     > agent kdh 01 rupiah banda
            +260977600123     < Thank you Rupiah Banda! You have successfully registered as a RemindMi Agent for zone 01 of Kafue District Hospital.
            +260977600123     > agent kdh 01 rupiah banda
            +260977600123     < Hello Rupiah Banda! You are already registered as a RemindMi Agent for zone 01 of Kafue District Hospital.
            admin  > join clinic kdh beyonce 1234
            admin  < Hi Beyonce, thanks for registering for Results160 from Kafue District Hospital. Your PIN is 1234. Reply with keyword 'HELP' if this is incorrect
            """
        self.runScript(script)
        admin = Contact.objects.get(connection__identity='admin')
        # @type admin Contact
    ...
    def testBadDate(self):
        ...
        script = """
            ...
            +260977600123     < Sorry, I couldn't understand that date. Please enter the date like so: DAY MONTH YEAR, for example: 23 04 2020
        """
        self.runScript(script)
        patients = Contact.objects.filter(types__slug='patient')
        self.assertEqual(0, patients.count())
    ...
    def testEventRegistrationDateFormats(self):
        ...
        reminders.Event.objects.create(name="Birth", slug="birth")
        script = """
            +260977600123     > birth 1/1/2020 maria
            +260977600123     < Thank you %(cba)s! You have successfully registered a birth for maria on 01/01/2020. You will be notified when it is time for his or her next appointment at the clinic.
            +260977600123     > birth 1 1 2020 laura
            +260977600123     < Thank you %(cba)s! You have successfully registered a birth for laura on 01/01/2020. You will be notified when it is time for his or her next appointment at the clinic.
            +260977600123     > birth 1-1-2020 anna
            +260977600123     < Thank you %(cba)s! You have successfully registered a birth for anna on 01/01/2020. You will be notified when it is time for his or her next appointment at the clinic.
            +260977600123     > birth 1.1.2020 michelle
            +260977600123     < Thank you %(cba)s! You have successfully registered a birth for michelle on 01/01/2020. You will be notified when it is time for his or her next appointment at the clinic.
            +260977600123     > birth 1. 1. 2020 anne
            +260977600123     < Thank you %(cba)s! You have successfully registered a birth for anne on 01/01/2020. You will be notified when it is time for his or her next appointment at the clinic.
            +260977600123     > birth 01012020 heidi
            +260977600123     < Thank you %(cba)s! You have successfully registered a birth for heidi on 01/01/2020. You will be notified when it is time for his or her next appointment at the clinic.
            ...
            +260977600123     < Thank you %(cba)s! You have successfully registered a birth for nancy on 01/01/%(year)s. You will be notified when it is time for his or her next appointment at the clinic.
            +260977600123     > birth 1-1 katrina
            +260977600123     < Thank you %(cba)s! You have successfully registered a birth for katrina on 01/01/%(year)s. You will be notified when it is time for his or her next appointment at the clinic.
            +260977600123     > birth 1.1 molly
            +260977600123     < Thank you %(cba)s! You have successfully registered a birth for molly on 01/01/%(year)s. You will be notified when it is time for his or her next appointment at the clinic.
            +260977600123     > birth 1. 1 lisa
            +260977600123     < Thank you %(cba)s! You have successfully registered a birth for lisa on 01/01/%(year)s. You will be notified when it is time for his or her next appointment at the clinic.
            +260977600123     > birth 0101 lauren
            +260977600123     < Thank you %(cba)s! You have successfully registered a birth for lauren on 01/01/%(year)s. You will be notified when it is time for his or her next appointment at the clinic.
        ...
        for patient in patients:
            ...
            self.assertEqual(patient_event.date, datetime.date(2020, 1, 1))
    ...
    def testCorrectMessageWithGender(self):
        ...
        script = """
            +260977600123     > birth 4/3/2019 maria
            +260977600123     < Thank you Rupiah Banda! You have successfully registered a birth for maria on 04/03/2019. You will be notified when it is time for her next appointment at the clinic.
        """
        self.runScript(script)
        patients = Contact.objects.filter(types__slug='patient')
    ...
    def testCorrectMessageWithoutRegisteringAgent(self):
        ...
        reminders.Event.objects.create(name="Birth", slug="birth")
        script = """
            aa     > birth 4/3/2019 maria
            aa     < Thank you! You have successfully registered a birth for maria on 04/03/2019. You will be notified when it is time for his or her next appointment at the clinic.
        """
        self.runScript(script)
        patients = Contact.objects.filter(types__slug='patient')
        self.assertEqual(1, patients.count())
    ...
    def testCorrectMessageWithManyKeywords(self):
        ...
        script = """
            +260977600123     > bIrth 4/3/2019 maria
            +260977600123     < Thank you Rupiah Banda! You have successfully registered a birth for maria on 04/03/2019. You will be notified when it is time for her next appointment at the clinic.
            +260977600123     > bith 4/3/2019 anna
            +260977600123     < Thank you Rupiah Banda! You have successfully registered a birth for anna on 04/03/2019. You will be notified when it is time for her next appointment at the clinic.
            +260977600123     > BILTH 4/3/2019 laura
            +260977600123     < Thank you Rupiah Banda! You have successfully registered a birth for laura on 04/03/2019. You will be notified when it is time for her next appointment at the clinic.
            +260977600123     > mwaNA 4/3/2019 lynn
            +260977600123     < Thank you Rupiah Banda! You have successfully registered a birth for lynn on 04/03/2019. You will be notified when it is time for her next appointment at the clinic.
            +260977600123     > unknownevent 4/3/2019 lynn
        """
        self.runScript(script)
        patients = Contact.objects.filter(types__slug='patient')
    ...
    def testCorrectMessageWithoutDate(self):
        ...
        reminders.Event.objects.create(name="Birth", slug="birth")
        script = """
            +260977600123     > birth maria
            +260977600123     < Thank you Rupiah Banda! You have successfully registered a birth for maria on %s. You will be notified when it is time for his or her next appointment at the clinic.
    ...
    def testFacilityBirthRegistration(self):
        ...
        script = """
            +260977600123     > mwana f 4/3/2019 maria
            +260977600123     < Thank you Rupiah Banda! You registered a facility birth for maria on 04/03/2019. You will be notified when it is time for her next clinic appointment.
            +260977600123     > mwanaf 4/3/2019 Nelly Daka
            +260977600123     < Thank you Rupiah Banda! You registered a facility birth for Nelly Daka on 04/03/2019. You will be notified when it is time for her next clinic appointment.
            +260977600123     > mwana facility 4/3/2019 Nelly Mwansa
            +260977600123     < Thank you Rupiah Banda! You registered a facility birth for Nelly Mwansa on 04/03/2019. You will be notified when it is time for her next clinic appointment.
        """
        self.runScript(script)
        patients = Contact.objects.filter(types__slug='patient')
    ...
    def testCommunityBirthRegistration(self):
        ...
        script = """
            +260977600123     > mwana h 4/3/2019 maria
            +260977600123     < Thank you Rupiah Banda! You registered a home birth for maria on 04/03/2019. You will be notified when it is time for her next clinic appointment.
            +260977600123     > mwana h 4/3/2019 maria
            +260977600123     < Thank you Rupiah Banda! You registered a home birth for maria on 04/03/2019. You will be notified when it is time for her next clinic appointment.
            +260977600123     > mwanah 4/3/2019 Nelly Daka
            +260977600123     < Thank you Rupiah Banda! You registered a home birth for Nelly Daka on 04/03/2019. You will be notified when it is time for her next clinic appointment.
        """
        self.runScript(script)
        patients = Contact.objects.filter(types__slug='patient')
    ...
    def testBirthRegistrationOnBehalfOf(self):
        self._register()
        reminders.Event.objects.create(name="Birth", slug="mwana|birth", gender='f')
        script = """
            unknown > mwanafor +260977600123 h 4/3/2019 maria
            ...
            admin > mwanafor +260977600000 h 4/3/2019 maria
            admin < The phone number +260977600000 does not belong to any CBA. Make sure you typed it correctly
            admin > mwanafor +260977600123 h 4/3/2019 maria
            admin < Thank you Beyonce! You have registered a home birth for Maria on 04/03/2019 on behalf of Rupiah Banda.
            admin > mwanafor 0977600123 f 4.5.2019 Tracy
            admin < Thank you Beyonce! You have registered a facility birth for Tracy on 04/05/2019 on behalf of Rupiah Banda.
            admin > mwanafor 977600123 4 6 2019 Shakira
            admin < Thank you Beyonce! You have registered a birth for Shakira on 04/06/2019 on behalf of Rupiah Banda.
        """
        self.runScript(script)
        patients = Contact.objects.filter(types__slug='patient')
        self.assertEqual(3, patients.count())
        ...
        script = """
            admin > mwanafor +260977600123 h 4/3/2019 maria
            admin < Maria with DOB 04/03/2019 is already for/by Rupiah Banda (+260977600123).
            admin > mwanafor 0977600123 f 4.5.2019 Tracy
            admin < Tracy with DOB 04/05/2019 is already for/by Rupiah Banda (+260977600123).
            admin > mwanafor 977600123 4 6 2019 Shakira
            admin < Shakira with DOB 04/06/2019 is already for/by Rupiah Banda (+260977600123).
        """
        self.runScript(script)
        patients = Contact.objects.filter(types__slug='patient')
        self.assertEqual(3, patients.count())
        self.assertEqual(1, reminders.PatientEvent.objects.filter(
            event_location_type='hm', cba_conn__identity='+260977600123').count())
        self.assertEqual(1, reminders.PatientEvent.objects.filter(
            event_location_type='cl', cba_conn__identity='+260977600123').count())

    def testFutureEventRegistration(self):
        self._register()
        reminders.Event.objects.create(name="Birth", slug="birth", gender='f')
        script = """
            +260977600123     > birth 4/6/2041 maria
            +260977600123     < Sorry, you can not register a birth with a date after today's.
        """
        self.runScript(script)
        patients = Contact.objects.filter(types__slug='patient')
        self.assertEqual(0, patients.count())
...
class MockReminders(TestScript):
    ...
    def testSendMockReminders(self):
        ...
        script = """
        kashitu_cba > birth 29 06 2019 Groovy Phiri
        kashitu_cba < Thank you Kashitu Cba! You have successfully registered a birth for Groovy Phiri on 29/06/2019. You will be notified when it is time for his or her next appointment at the clinic.
        demo_initiator > rmdemo 402026
