SELECT distinct parent."name", clinic, --phone,
rapidsms_contact.name,
messagelog_message.date ::date as "Date",messagelog_message.text
...
and messagelog_message.text ilike 'trace%'
--and parent.slug like '80%'

--group by province."name",clinic, contactsplus_contacttype.slug--, phone
order by 1,2,3
