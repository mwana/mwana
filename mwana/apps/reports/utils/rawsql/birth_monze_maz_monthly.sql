...
month(messagelog_message.date ::date) as "Month"
,'Birth' as "Command"
...
and (messagelog_message.text ilike 'birth%' or messagelog_message.text ilike 'mwana%')
--and parent.slug like '80%'

group by parent."name",clinic, "Year","Month"--, contactsplus_contacttype.slug--, phone
order by 1,2,3,4;
