...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HelpRequest.comments'
        db.add_column('help_helprequest', 'comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'HelpRequest.resolved_by'
        db.add_column('help_helprequest', 'resolved_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HelpRequest.comments'
        db.delete_column('help_helprequest', 'comments')

        # Deleting field 'HelpRequest.resolved_by'
        db.delete_column('help_helprequest', 'resolved_by_id')
    ...
    models = {
        ...
        'help.helprequest': {
            ...
            'additional_text': ('django.db.models.fields.CharField', [], {'max_length': '160'}),
