...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HelpRequest'
        db.create_table('help_helprequest', (
            ...
            ('additional_text', self.gf('django.db.models.fields.CharField')(max_length=160)),
            ('status', self.gf('django.db.models.fields.CharField')(default='P', max_length=1)),
        ))
        db.send_create_signal('help', ['HelpRequest'])


    def backwards(self, orm):
        
        # Deleting model 'HelpRequest'
        db.delete_table('help_helprequest')
