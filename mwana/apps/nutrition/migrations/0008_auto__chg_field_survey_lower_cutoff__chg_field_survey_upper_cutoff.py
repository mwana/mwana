...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Survey.lower_cutoff'
        db.alter_column('nutrition_survey', 'lower_cutoff', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))

        # Changing field 'Survey.upper_cutoff'
        db.alter_column('nutrition_survey', 'upper_cutoff', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'Survey.lower_cutoff'
        db.alter_column('nutrition_survey', 'lower_cutoff', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Survey.upper_cutoff'
        db.alter_column('nutrition_survey', 'upper_cutoff', self.gf('django.db.models.fields.IntegerField')())
