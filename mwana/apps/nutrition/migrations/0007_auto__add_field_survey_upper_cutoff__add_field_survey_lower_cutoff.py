...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('nutrition_survey', 'upper_cutoff', self.gf('django.db.models.fields.IntegerField')(default=3), keep_default=False)

        # Adding field 'Survey.lower_cutoff'
        db.add_column('nutrition_survey', 'lower_cutoff', self.gf('django.db.models.fields.IntegerField')(default=-3), keep_default=False)
    ...
    models = {
        ...
        'nutrition.survey': {
            ...
            'lower_cutoff': ('django.db.models.fields.IntegerField', [], {'default': '-3'}),
            'upper_cutoff': ('django.db.models.fields.IntegerField', [], {'default': '3'})
        },
