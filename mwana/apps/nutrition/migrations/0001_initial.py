...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('nutrition_assessment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('healthworker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Contact'], null=True)),
            ('patient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Person'])),
            ('survey', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nutrition.Survey'])),
            ...
            ('muac', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True)),
            ('oedema', self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True)),
        ...
        db.send_create_signal('nutrition', ['Assessment'])

        # Adding model 'SurveyEntry'
        db.create_table('nutrition_surveyentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('flag', self.gf('django.db.models.fields.CharField')(default='G', max_length=1)),
            ('survey_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('healthworker_id', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('cluster_id', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('child_id', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('household_id', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('gender', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('date_of_birth', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('age_in_months', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('height', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('weight', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('oedema', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
            ('muac', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
        ))
        db.send_create_signal('nutrition', ['SurveyEntry'])

        # Adding model 'Survey'
        db.create_table('nutrition_survey', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('baseline_weight4age', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True)),
            ('baseline_height4age', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True)),
            ('baseline_weight4height', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True)),
            ('avg_weight4age', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True)),
            ('avg_height4age', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True)),
            ('avg_weight4height', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True)),
        ))
        db.send_create_signal('nutrition', ['Survey'])


    def backwards(self, orm):
        
        # Deleting model 'Assessment'
        db.delete_table('nutrition_assessment')

        # Deleting model 'SurveyEntry'
        db.delete_table('nutrition_surveyentry')

        # Deleting model 'Survey'
        db.delete_table('nutrition_survey')
    ...
    models = {
        ...
        'nutrition.surveyentry': {
            ...
            'cluster_id': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            ...
            'household_id': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
