...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Assessment.muac_status'
        db.delete_column('nutrition_assessment', 'muac_status')

        # Deleting field 'Assessment.w4hstatus'
        db.delete_column('nutrition_assessment', 'w4hstatus')

        # Deleting field 'Assessment.h4astatus'
        db.delete_column('nutrition_assessment', 'h4astatus')

        # Deleting field 'Assessment.w4astatus'
        db.delete_column('nutrition_assessment', 'w4astatus')

        # Adding field 'Assessment.underweight'
        db.add_column('nutrition_assessment', 'underweight', self.gf('django.db.models.fields.CharField')(default='N', max_length=1), keep_default=False)

        # Adding field 'Assessment.stunting'
        db.add_column('nutrition_assessment', 'stunting', self.gf('django.db.models.fields.CharField')(default='N', max_length=1), keep_default=False)

        # Adding field 'Assessment.wasting'
        db.add_column('nutrition_assessment', 'wasting', self.gf('django.db.models.fields.CharField')(default='N', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Assessment.muac_status'
        db.add_column('nutrition_assessment', 'muac_status', self.gf('django.db.models.fields.CharField')(default='N', max_length=1), keep_default=False)

        # Adding field 'Assessment.w4hstatus'
        db.add_column('nutrition_assessment', 'w4hstatus', self.gf('django.db.models.fields.CharField')(default='N', max_length=1), keep_default=False)

        # Adding field 'Assessment.h4astatus'
        db.add_column('nutrition_assessment', 'h4astatus', self.gf('django.db.models.fields.CharField')(default='N', max_length=1), keep_default=False)

        # Adding field 'Assessment.w4astatus'
        db.add_column('nutrition_assessment', 'w4astatus', self.gf('django.db.models.fields.CharField')(default='N', max_length=1), keep_default=False)

        # Deleting field 'Assessment.underweight'
        db.delete_column('nutrition_assessment', 'underweight')

        # Deleting field 'Assessment.stunting'
        db.delete_column('nutrition_assessment', 'stunting')

        # Deleting field 'Assessment.wasting'
        db.delete_column('nutrition_assessment', 'wasting')
