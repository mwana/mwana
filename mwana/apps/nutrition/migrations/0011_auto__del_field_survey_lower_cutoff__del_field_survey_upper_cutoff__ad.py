...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Survey.lower_cutoff'
        db.delete_column('nutrition_survey', 'lower_cutoff')

        # Deleting field 'Survey.upper_cutoff'
        db.delete_column('nutrition_survey', 'upper_cutoff')

        # Adding field 'Survey.normal_muac'
        db.add_column('nutrition_survey', 'normal_muac', self.gf('django.db.models.fields.DecimalField')(default=13.5, max_digits=4, decimal_places=2), keep_default=False)

        # Adding field 'Survey.mild_muac'
        db.add_column('nutrition_survey', 'mild_muac', self.gf('django.db.models.fields.DecimalField')(default=12.5, max_digits=4, decimal_places=2), keep_default=False)

        # Adding field 'Survey.severe_muac'
        db.add_column('nutrition_survey', 'severe_muac', self.gf('django.db.models.fields.DecimalField')(default=11.5, max_digits=4, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Survey.lower_cutoff'
        db.add_column('nutrition_survey', 'lower_cutoff', self.gf('django.db.models.fields.DecimalField')(default=-3.0, max_digits=4, decimal_places=2), keep_default=False)

        # Adding field 'Survey.upper_cutoff'
        db.add_column('nutrition_survey', 'upper_cutoff', self.gf('django.db.models.fields.DecimalField')(default=3.0, max_digits=4, decimal_places=2), keep_default=False)

        # Deleting field 'Survey.normal_muac'
        db.delete_column('nutrition_survey', 'normal_muac')

        # Deleting field 'Survey.mild_muac'
        db.delete_column('nutrition_survey', 'mild_muac')

        # Deleting field 'Survey.severe_muac'
        db.delete_column('nutrition_survey', 'severe_muac')
