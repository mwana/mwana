...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SurveyEntry.healthworker_id'
        db.delete_column('nutrition_surveyentry', 'healthworker_id')


    def backwards(self, orm):
        
        # Adding field 'SurveyEntry.healthworker_id'
        db.add_column('nutrition_surveyentry', 'healthworker_id', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)
