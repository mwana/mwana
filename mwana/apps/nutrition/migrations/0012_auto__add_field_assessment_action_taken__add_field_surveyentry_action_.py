...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Assessment.action_taken'
        db.add_column('nutrition_assessment', 'action_taken', self.gf('django.db.models.fields.CharField')(default='RG', max_length=2), keep_default=False)

        # Adding field 'SurveyEntry.action_taken'
        db.add_column('nutrition_surveyentry', 'action_taken', self.gf('django.db.models.fields.CharField')(default='RG', max_length=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Assessment.action_taken'
        db.delete_column('nutrition_assessment', 'action_taken')

        # Deleting field 'SurveyEntry.action_taken'
        db.delete_column('nutrition_surveyentry', 'action_taken')
