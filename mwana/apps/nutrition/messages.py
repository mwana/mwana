...
INVALID_MEASUREMENT = "Possible measurement error. Please check height, weight, MUAC or age of child _ child_id %s."
REPORT_CONFIRM = "Thanks, %s. Received %s."
INVALID_MESSAGE = "Sorry, I don't understand."
CANCEL_HELP = "To cancel the last report and assessmnent for a child send: CANCEL <CHILD ID>."
