...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contact.created_date'
        db.add_column('rapidsms_contact', 'created_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.date(2012, 11, 15), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.created_date'
        db.delete_column('rapidsms_contact', 'created_date')
