...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contact.unique_id'
        db.add_column('rapidsms_contact', 'unique_id', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.unique_id'
        db.delete_column('rapidsms_contact', 'unique_id')
