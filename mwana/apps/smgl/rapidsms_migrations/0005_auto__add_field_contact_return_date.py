...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contact.return_date'
        db.add_column('rapidsms_contact', 'return_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.return_date'
        db.delete_column('rapidsms_contact', 'return_date')
