...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contact.is_super_user'
        db.add_column('rapidsms_contact', 'is_super_user', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.is_super_user'
        db.delete_column('rapidsms_contact', 'is_super_user')
