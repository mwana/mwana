...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DeathRegistration'
        db.create_table('smgl_deathregistration', (
            ...
            ('unique_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('person', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('place', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('smgl', ['DeathRegistration'])

        # Adding model 'BirthRegistration'
        db.create_table('smgl_birthregistration', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Contact'], null=True)),
            ('connection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Connection'])),
            ('unique_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ...
            ('place', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('complications', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('number', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('smgl', ['BirthRegistration'])


    def backwards(self, orm):
        
        # Deleting model 'DeathRegistration'
        db.delete_table('smgl_deathregistration')

        # Deleting model 'BirthRegistration'
        db.delete_table('smgl_birthregistration')
