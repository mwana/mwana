...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacilityVisit.visit_type'
        db.add_column('smgl_facilityvisit', 'visit_type', self.gf('django.db.models.fields.CharField')(default='anc', max_length=255), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'FacilityVisit.visit_type'
        db.delete_column('smgl_facilityvisit', 'visit_type')
