...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacilityVisit.created_date'
        db.add_column('smgl_facilityvisit', 'created_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'PregnantMother.created_date'
        db.add_column('smgl_pregnantmother', 'created_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacilityVisit.created_date'
        db.delete_column('smgl_facilityvisit', 'created_date')

        # Deleting field 'PregnantMother.created_date'
        db.delete_column('smgl_pregnantmother', 'created_date')
