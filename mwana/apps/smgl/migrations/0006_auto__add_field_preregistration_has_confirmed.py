...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PreRegistration.has_confirmed'
        db.add_column('smgl_preregistration', 'has_confirmed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PreRegistration.has_confirmed'
        db.delete_column('smgl_preregistration', 'has_confirmed')
