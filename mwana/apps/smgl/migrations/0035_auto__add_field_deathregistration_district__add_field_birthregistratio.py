...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DeathRegistration.district'
        db.add_column('smgl_deathregistration', 'district', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'], null=True, blank=True), keep_default=False)

        # Adding field 'BirthRegistration.district'
        db.add_column('smgl_birthregistration', 'district', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DeathRegistration.district'
        db.delete_column('smgl_deathregistration', 'district_id')

        # Deleting field 'BirthRegistration.district'
        db.delete_column('smgl_birthregistration', 'district_id')
