...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('smgl_referral', (
            ...
            ('facility', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'])),
        ))
        db.send_create_signal('smgl', ['Referral'])


    def backwards(self, orm):
        
        # Deleting model 'Referral'
        db.delete_table('smgl_referral')
