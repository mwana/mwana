...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AmbulanceOutcome.form_id'
        db.add_column('smgl_ambulanceoutcome', 'form_id', self.gf('django.db.models.fields.CharField')(default=1, max_length=100), keep_default=False)

        # Adding field 'AmbulanceOutcome.session'
        db.add_column('smgl_ambulanceoutcome', 'session', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['smsforms.XFormsSession']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AmbulanceOutcome.form_id'
        db.delete_column('smgl_ambulanceoutcome', 'form_id')

        # Deleting field 'AmbulanceOutcome.session'
        db.delete_column('smgl_ambulanceoutcome', 'session_id')
