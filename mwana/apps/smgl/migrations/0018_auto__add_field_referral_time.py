...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Referral.time'
        db.add_column('smgl_referral', 'time', self.gf('django.db.models.fields.TimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Referral.time'
        db.delete_column('smgl_referral', 'time')
