...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ToldReminder'
        db.create_table('smgl_toldreminder', (
        ...
        db.send_create_signal('smgl', ['ToldReminder'])


    def backwards(self, orm):
        
        # Deleting model 'ToldReminder'
        db.delete_table('smgl_toldreminder')
