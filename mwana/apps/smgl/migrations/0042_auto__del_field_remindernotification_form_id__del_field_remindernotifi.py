...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ReminderNotification.form_id'
        raise RuntimeError("Cannot reverse this migration. 'ReminderNotification.form_id' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ReminderNotification.session'
        raise RuntimeError("Cannot reverse this migration. 'ReminderNotification.session' and its values cannot be restored.")
