...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AmbulanceRequest.connection'
        db.delete_column('smgl_ambulancerequest', 'connection_id')

        # Adding field 'AmbulanceRequest.form_id'
        db.add_column('smgl_ambulancerequest', 'form_id', self.gf('django.db.models.fields.CharField')(default=1, max_length=100), keep_default=False)

        # Adding field 'AmbulanceRequest.session'
        db.add_column('smgl_ambulancerequest', 'session', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['smsforms.XFormsSession']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'AmbulanceRequest.connection'
        db.add_column('smgl_ambulancerequest', 'connection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Connection'], null=True, blank=True), keep_default=False)

        # Deleting field 'AmbulanceRequest.form_id'
        db.delete_column('smgl_ambulancerequest', 'form_id')

        # Deleting field 'AmbulanceRequest.session'
        db.delete_column('smgl_ambulancerequest', 'session_id')
