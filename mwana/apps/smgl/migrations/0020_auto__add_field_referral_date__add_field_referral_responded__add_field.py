...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Referral.date'
        db.add_column('smgl_referral', 'date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 7, 5, 20, 24, 37, 99000)), keep_default=False)

        # Adding field 'Referral.responded'
        db.add_column('smgl_referral', 'responded', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Referral.mother_showed'
        db.add_column('smgl_referral', 'mother_showed', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Referral.mother_outcome'
        db.add_column('smgl_referral', 'mother_outcome', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True), keep_default=False)

        # Adding field 'Referral.baby_outcome'
        db.add_column('smgl_referral', 'baby_outcome', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True), keep_default=False)

        # Adding field 'Referral.mode_of_delivery'
        db.add_column('smgl_referral', 'mode_of_delivery', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Referral.date'
        db.delete_column('smgl_referral', 'date')

        # Deleting field 'Referral.responded'
        db.delete_column('smgl_referral', 'responded')

        # Deleting field 'Referral.mother_showed'
        db.delete_column('smgl_referral', 'mother_showed')

        # Deleting field 'Referral.mother_outcome'
        db.delete_column('smgl_referral', 'mother_outcome')

        # Deleting field 'Referral.baby_outcome'
        db.delete_column('smgl_referral', 'baby_outcome')

        # Deleting field 'Referral.mode_of_delivery'
        db.delete_column('smgl_referral', 'mode_of_delivery')
    ...
    models = {
        ...
        'smgl.referral': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mode_of_delivery': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
            'mother': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['smgl.PregnantMother']", 'null': 'True', 'blank': 'True'}),
