...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SyphilisTreatment.district'
        db.add_column('smgl_syphilistreatment', 'district', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'], null=True, blank=True), keep_default=False)

        # Adding field 'SyphilisTest.district'
        db.add_column('smgl_syphilistest', 'district', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SyphilisTreatment.district'
        db.delete_column('smgl_syphilistreatment', 'district_id')

        # Deleting field 'SyphilisTest.district'
        db.delete_column('smgl_syphilistest', 'district_id')
