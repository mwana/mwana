...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AmbulanceRequest'
        db.create_table('smgl_ambulancerequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Contact'], null=True, blank=True)),
            ('connection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Connection'], null=True, blank=True)),
            ...
            ('danger_sign', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('smgl', ['AmbulanceRequest'])


    def backwards(self, orm):
        
        # Deleting model 'AmbulanceRequest'
        db.delete_table('smgl_ambulancerequest')
