...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Referral.mode_of_delivery'
        db.alter_column('smgl_referral', 'mode_of_delivery', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))


    def backwards(self, orm):
        
        # Changing field 'Referral.mode_of_delivery'
        db.alter_column('smgl_referral', 'mode_of_delivery', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))
