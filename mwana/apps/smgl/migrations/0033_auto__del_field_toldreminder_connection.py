...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ToldReminder.connection'
        db.delete_column('smgl_toldreminder', 'connection_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ToldReminder.connection'
        raise RuntimeError("Cannot reverse this migration. 'ToldReminder.connection' and its values cannot be restored.")
