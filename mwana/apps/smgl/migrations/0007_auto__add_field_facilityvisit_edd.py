...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacilityVisit.edd'
        db.add_column('smgl_facilityvisit', 'edd', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacilityVisit.edd'
        db.delete_column('smgl_facilityvisit', 'edd')
