...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.drop_foreign_key('smgl_pregnantmother', 'tmp_zone_id')
        db.rename_column('smgl_pregnantmother', 'tmp_zone_id', 'zone_id')
        db.alter_column('smgl_pregnantmother', 'zone_id', models.ForeignKey(null=True, to=orm['locations.Location']))
        
    def backwards(self, orm):
        db.drop_foreign_key('smgl_pregnantmother', 'zone_id')
        db.rename_column('smgl_pregnantmother', 'zone_id', 'tmp_zone_id')
        db.alter_column('smgl_pregnantmother', 'tmp_zone_id', models.ForeignKey(null=True, to=orm['locations.Location']))
