...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FacilityVisit.next_visit'
        db.alter_column('smgl_facilityvisit', 'next_visit', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'FacilityVisit.next_visit'
        raise RuntimeError("Cannot reverse this migration. 'FacilityVisit.next_visit' and its values cannot be restored.")
