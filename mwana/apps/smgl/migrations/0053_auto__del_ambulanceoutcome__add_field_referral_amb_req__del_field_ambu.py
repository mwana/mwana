...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'AmbulanceOutcome'
        db.delete_table('smgl_ambulanceoutcome')

        # Adding field 'Referral.amb_req'
        db.add_column('smgl_referral', 'amb_req', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smgl.AmbulanceRequest'], null=True, blank=True), keep_default=False)
        ...
        # Deleting field 'AmbulanceRequest.contact'
        db.delete_column('smgl_ambulancerequest', 'contact_id')

        # Deleting field 'AmbulanceRequest.receiving_facility'
        db.delete_column('smgl_ambulancerequest', 'receiving_facility_id')

        # Deleting field 'AmbulanceRequest.danger_sign'
        db.delete_column('smgl_ambulancerequest', 'danger_sign')
    ...
    def backwards(self, orm):
        ...
        # Adding model 'AmbulanceOutcome'
        db.create_table('smgl_ambulanceoutcome', (
            ('mother_uid', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('ambulance_request', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smgl.AmbulanceRequest'], null=True, blank=True)),
            ...
            ('mother', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smgl.PregnantMother'], null=True, blank=True)),
            ('outcome_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('outcome', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('no_amb', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('smgl', ['AmbulanceOutcome'])

        # Deleting field 'Referral.amb_req'
        db.delete_column('smgl_referral', 'amb_req_id')
        ...
        db.add_column('smgl_ambulancerequest', 'from_location', self.gf('django.db.models.fields.related.ForeignKey')(related_name='from_location', null=True, to=orm['locations.Location'], blank=True), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'AmbulanceRequest.requested_on'
        raise RuntimeError("Cannot reverse this migration. 'AmbulanceRequest.requested_on' and its values cannot be restored.")

        # Adding field 'AmbulanceRequest.contact'
        db.add_column('smgl_ambulancerequest', 'contact', self.gf('django.db.models.fields.related.ForeignKey')(related_name='er_iniator', null=True, to=orm['rapidsms.Contact'], blank=True), keep_default=False)

        # Adding field 'AmbulanceRequest.receiving_facility'
        db.add_column('smgl_ambulancerequest', 'receiving_facility', self.gf('django.db.models.fields.related.ForeignKey')(related_name='receiving_facility', null=True, to=orm['locations.Location'], blank=True), keep_default=False)

        # Adding field 'AmbulanceRequest.danger_sign'
        db.add_column('smgl_ambulancerequest', 'danger_sign', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'AmbulanceRequest.receiving_facility_recipient'
        db.add_column('smgl_ambulancerequest', 'receiving_facility_recipient', self.gf('django.db.models.fields.related.ForeignKey')(related_name='receiving_facility_recipient', null=True, to=orm['rapidsms.Contact'], blank=True), keep_default=False)
