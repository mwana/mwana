...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PreRegistration.facility_name'
        db.delete_column('smgl_preregistration', 'facility_name')

        # Deleting field 'PreRegistration.facility_code'
        db.delete_column('smgl_preregistration', 'facility_code')

        # Changing field 'PreRegistration.location'
        db.alter_column('smgl_preregistration', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['locations.Location']))


    def backwards(self, orm):
        
        # Adding field 'PreRegistration.facility_name'
        db.add_column('smgl_preregistration', 'facility_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'PreRegistration.facility_code'
        db.add_column('smgl_preregistration', 'facility_code', self.gf('django.db.models.fields.CharField')(default='invalid_code', max_length=255), keep_default=False)

        # Changing field 'PreRegistration.location'
        db.alter_column('smgl_preregistration', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'], null=True))
