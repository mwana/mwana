...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AmbulanceOutcome.no_amb'
        db.add_column('smgl_ambulanceoutcome', 'no_amb', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AmbulanceOutcome.no_amb'
        db.delete_column('smgl_ambulanceoutcome', 'no_amb')
