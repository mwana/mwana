...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SyphilisTreatment'
        db.create_table('smgl_syphilistreatment', (
            ...
            ('shot_number', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ))
        db.send_create_signal('smgl', ['SyphilisTreatment'])


    def backwards(self, orm):
        
        # Deleting model 'SyphilisTreatment'
        db.delete_table('smgl_syphilistreatment')
