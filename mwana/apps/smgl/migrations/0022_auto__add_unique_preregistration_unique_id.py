...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'PreRegistration', fields ['unique_id']
        db.create_unique('smgl_preregistration', ['unique_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'PreRegistration', fields ['unique_id']
        db.delete_unique('smgl_preregistration', ['unique_id'])
