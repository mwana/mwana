...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Suggestion.closed'
        db.add_column('smgl_suggestion', 'closed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Suggestion.close_comment'
        db.add_column('smgl_suggestion', 'close_comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Suggestion.closed'
        db.delete_column('smgl_suggestion', 'closed')

        # Deleting field 'Suggestion.close_comment'
        db.delete_column('smgl_suggestion', 'close_comment')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 30, 21, 4, 55, 950036)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 30, 21, 4, 55, 949947)'}),
