...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Referral.from_facility'
        db.add_column('smgl_referral', 'from_facility', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='referrals_made', null=True, to=orm['locations.Location']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Referral.from_facility'
        db.delete_column('smgl_referral', 'from_facility_id')
