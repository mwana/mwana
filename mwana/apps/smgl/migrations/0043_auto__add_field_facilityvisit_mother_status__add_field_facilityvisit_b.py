...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacilityVisit.mother_status'
        db.add_column('smgl_facilityvisit', 'mother_status', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True), keep_default=False)

        # Adding field 'FacilityVisit.baby_status'
        db.add_column('smgl_facilityvisit', 'baby_status', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True), keep_default=False)

        # Adding field 'FacilityVisit.referred'
        db.add_column('smgl_facilityvisit', 'referred', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacilityVisit.mother_status'
        db.delete_column('smgl_facilityvisit', 'mother_status')

        # Deleting field 'FacilityVisit.baby_status'
        db.delete_column('smgl_facilityvisit', 'baby_status')

        # Deleting field 'FacilityVisit.referred'
        db.delete_column('smgl_facilityvisit', 'referred')
