...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AmbulanceResponse.form_id'
        db.add_column('smgl_ambulanceresponse', 'form_id', self.gf('django.db.models.fields.CharField')(default=1, max_length=100), keep_default=False)

        # Adding field 'AmbulanceResponse.session'
        db.add_column('smgl_ambulanceresponse', 'session', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['smsforms.XFormsSession']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AmbulanceResponse.form_id'
        db.delete_column('smgl_ambulanceresponse', 'form_id')

        # Deleting field 'AmbulanceResponse.session'
        db.delete_column('smgl_ambulanceresponse', 'session_id')
