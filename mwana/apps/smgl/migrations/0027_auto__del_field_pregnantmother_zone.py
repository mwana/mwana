...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PregnantMother.zone'
        db.delete_column('smgl_pregnantmother', 'zone')


    def backwards(self, orm):
        
        # Adding field 'PregnantMother.zone'
        db.add_column('smgl_pregnantmother', 'zone', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True), keep_default=False)
