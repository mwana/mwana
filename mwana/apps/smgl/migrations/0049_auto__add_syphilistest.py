...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SyphilisTest'
        db.create_table('smgl_syphilistest', (
        ...
        db.send_create_signal('smgl', ['SyphilisTest'])


    def backwards(self, orm):
        
        # Deleting model 'SyphilisTest'
        db.delete_table('smgl_syphilistest')
