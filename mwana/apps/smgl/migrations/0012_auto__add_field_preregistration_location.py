...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PreRegistration.location'
        db.add_column('smgl_preregistration', 'location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PreRegistration.location'
        db.delete_column('smgl_preregistration', 'location_id')
