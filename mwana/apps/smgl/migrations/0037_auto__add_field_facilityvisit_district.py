...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Update the district field value for current record
    ...
    models = {
        ...
        'smgl.facilityvisit': {
            ...
            'district': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'district_location'", 'null': 'True', 'to': "orm['locations.Location']"}),
