...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Referral.reason_pp'
        db.add_column('smgl_referral', 'reason_pp', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'BirthRegistration.location'
        db.add_column('smgl_birthregistration', 'location', self.gf('django.db.models.fields.related.ForeignKey')(related_name='birth_location', null=True, to=orm['locations.Location']), keep_default=False)

        # Adding field 'DeathRegistration.location'
        db.add_column('smgl_deathregistration', 'location', self.gf('django.db.models.fields.related.ForeignKey')(related_name='death_location', null=True, to=orm['locations.Location']), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Referral.reason_pp'
        db.delete_column('smgl_referral', 'reason_pp')

        # Deleting field 'BirthRegistration.location'
        db.delete_column('smgl_birthregistration', 'location_id')

        # Deleting field 'DeathRegistration.location'
        db.delete_column('smgl_deathregistration', 'location_id')
