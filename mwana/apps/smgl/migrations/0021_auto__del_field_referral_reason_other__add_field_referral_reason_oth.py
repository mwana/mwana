...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Referral.reason_oth'
        db.add_column('smgl_referral', 'reason_oth', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Referral.reason_oth'
        db.delete_column('smgl_referral', 'reason_oth')
