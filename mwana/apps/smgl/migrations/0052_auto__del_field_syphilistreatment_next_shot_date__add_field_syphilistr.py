...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SyphilisTreatment.next_shot_date'
        db.delete_column('smgl_syphilistreatment', 'next_shot_date')

        # Adding field 'SyphilisTreatment.next_visit_date'
        db.add_column('smgl_syphilistreatment', 'next_visit_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'SyphilisTreatment.reminded'
        db.add_column('smgl_syphilistreatment', 'reminded', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'SyphilisTreatment.next_shot_date'
        db.add_column('smgl_syphilistreatment', 'next_shot_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Deleting field 'SyphilisTreatment.next_visit_date'
        db.delete_column('smgl_syphilistreatment', 'next_visit_date')

        # Deleting field 'SyphilisTreatment.reminded'
        db.delete_column('smgl_syphilistreatment', 'reminded')
    ...
    models = {
        ...
        'smgl.ambulanceoutcome': {
            ...
            'no_amb': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
