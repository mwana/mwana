...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BirthRegistration.unique_id'
        db.delete_column('smgl_birthregistration', 'unique_id')

        # Adding field 'BirthRegistration.mother'
        db.add_column('smgl_birthregistration', 'mother', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smgl.PregnantMother'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'BirthRegistration.unique_id'
        db.add_column('smgl_birthregistration', 'unique_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Deleting field 'BirthRegistration.mother'
        db.delete_column('smgl_birthregistration', 'mother_id')
