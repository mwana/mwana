...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AmbulanceResponse'
        db.create_table('smgl_ambulanceresponse', (
            ...
            ('response', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
        db.send_create_signal('smgl', ['AmbulanceResponse'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AmbulanceResponse'
        db.delete_table('smgl_ambulanceresponse')
