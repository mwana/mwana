...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ReminderNotification'
        db.create_table('smgl_remindernotification', (
        ...
        db.send_create_signal('smgl', ['ReminderNotification'])

        # Adding field 'Referral.reminded'
        db.add_column('smgl_referral', 'reminded', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'FacilityVisit.reminded'
        db.add_column('smgl_facilityvisit', 'reminded', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'PregnantMother.reminded'
        db.add_column('smgl_pregnantmother', 'reminded', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ReminderNotification'
        db.delete_table('smgl_remindernotification')

        # Deleting field 'Referral.reminded'
        db.delete_column('smgl_referral', 'reminded')

        # Deleting field 'FacilityVisit.reminded'
        db.delete_column('smgl_facilityvisit', 'reminded')

        # Deleting field 'PregnantMother.reminded'
        db.delete_column('smgl_pregnantmother', 'reminded')
