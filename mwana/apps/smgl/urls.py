...
urlpatterns = patterns('',
    ...
    url(r"^anc-report/$", views.anc_delivery_report, name="anc-report"),
    ...
    #url(r"^reminder-report/$", views.reminder_report, name="reminder-report"),
    url(r"^reports-main/$", views.reports_main, name="reports_main"),
    url(r"^reports-tabs/$", views.reports_tabs, name="reports_tabs"),
    url(r"^statistics/report/$", views.report, name="report"),
    url(r"^statistics/(?P<id>[\d]+)/$", views.statistics,
            name="district-stats"),
    #url(r"^statistics/reminder-stats/$", views.reminder_report, name="reminder-stats"),
    ...
    url(r"^error/$", views.error, name="error-page"),
