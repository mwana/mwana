...
urlpatterns = patterns('',
    ...
    url(r"^anc-report/$", views.anc_report, name="anc-report"),
    ...
    url(r"^reminder-report/$", views.reminder_stats, name="reminder-report"),
    url(r"^reminder-report-smag/$", views.reminder_stats,
        {'smag_table_requested':True},
        name="reminder-report-smag",
    ),
    url(r"^reports-main/$", views.reports_main, name="reports_main"),
    url(r"^reports-tabs/$", views.reports_tabs, name="reports_tabs"),
    url(r"^statistics/report/$", views.reports_tabs, name="report"),
